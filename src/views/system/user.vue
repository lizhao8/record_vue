<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.username" :placeholder="$t('table.username')" clearable style="width: 200px;" class="filter-item"
                @keyup.enter.native="handleFilter"/>
      <el-input v-model="listQuery.realName" :placeholder="$t('table.realName')" clearable style="width: 200px"
                 class="filter-item">
      </el-input>
    ...
    >
      ...
      <el-table-column :label="$t('table.lastLoginTime')" width="150px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column :label="$t('table.status')" class-name="status-col" width="200">
        <template slot-scope="{row}">
...
<script>
  import { getList, fetchPv, createArticle, updateArticle } from '@/api/system/user'
